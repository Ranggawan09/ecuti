        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    @elseif ($role == 'pegawai')
                    <!-- Dashboard User -->
                    <li class="list-none pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 {{ Request::routeIs('pegawai.dashboard') ? 'bg-green-500/[0.12] dark:bg-green-500/[0.24]' : 'bg-[linear-gradient(135deg,var(--tw-gradient-stops))]' }}">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition" href="{{ route('pegawai.dashboard') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current {{ Request::routeIs('pegawai.dashboard') ? 'text-green-500' : 'text-gray-400 dark:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M5.936.278A7.983 7.983 0 0 1 8 0a8 8 0 1 1-8 8c0-.722.104-1.413.278-2.064a1 1 0 1 1 1.932.516A5.99 5.99 0 0 0 2 8a6 6 0 1 0 6-6c-.53 0-1.045.076-1.548.21A1 1 0 1 1 5.936.278Z" />
                                    <path d="M6.068 7.482A2.003 2.003 0 0 0 8 10a2 2 0 1 0-.518-3.932L3.707 2.293a1 1 0 0 0-1.414 1.414l3.775 3.775Z" />
                                </svg>
                    ...
                    <li class="list-none pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] {{ Request::routeIs('pegawai.daftarPengajuan') ? 'bg-green-500/[0.12] dark:bg-green-500/[0.24]' : 'bg-[linear-gradient(135deg,var(--tw-gradient-stops))]' }}">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['pegawai.daftarPengajuan'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="{{ route('pegawai.daftarPengajuan') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current {{ Request::routeIs('pegawai.daftarPengajuan') ? 'text-green-500' : 'text-gray-400 dark:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                    ...
                    <li class="list-none pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] {{ Request::routeIs('pegawai.tambahPengajuan') ? 'bg-green-500/[0.12] dark:bg-green-500/[0.24]' : 'bg-[linear-gradient(135deg,var(--tw-gradient-stops))]' }}">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['pegawai.tambahPengajuan'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="{{ route('pegawai.tambahPengajuan') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current {{ Request::routeIs('pegawai.tambahPengajuan') ? 'text-green-500' : 'text-gray-400 dark:text-gray-500' }}" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
