...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Dashboard Atasan Langsung</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Selamat datang, <strong>{{ auth()->user()->nama ?? '-' }}</strong></p>
        </div>
        <div>
            <a href="{{ route('atasan-langsung.approvals.index') }}"
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="col-span-2 lg:col-span-1 bg-gradient-to-br from-amber-500 to-amber-700 rounded-xl p-5 text-white shadow-sm">
            ...
            <div class="text-xs opacity-70">Perlu tindakan segera</div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-700/60">
            <div class="flex items-center justify-between mb-3">
                ...
                <div class="w-8 h-8 bg-violet-100 dark:bg-violet-500/20 rounded-full flex items-center justify-center">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Bawahan langsung</div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center justify-between">
                ...
                <span class="text-xs bg-violet-100 dark:bg-violet-500/30 text-violet-600 dark:text-violet-400 rounded-full px-2 py-1">{{ $stats['total_pegawai'] }} pegawai</span>
            </header>
            <div class="p-4">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                <td class="p-3">
                                    <div class="flex items-center gap-2">
                                        <div class="w-8 h-8 bg-violet-100 dark:bg-violet-500/20 rounded-full flex items-center justify-center shrink-0">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl mb-6">
        <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center justify-between">
            ...
            <a href="{{ route('atasan-langsung.approvals.index') }}" class="text-sm text-violet-500 hover:text-violet-600 font-medium">Proses semua →</a>
        </header>
        <div class="p-4">
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20">
                    ...
                    <a href="{{ route('atasan-langsung.approvals.show', $lr) }}"
                       class="text-xs font-medium px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-600 text-white transition-colors shrink-0">
                        Tinjau
                    </a>
                </div>
                @endforeach
    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl">
        <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60 flex items-center justify-between">
            ...
            <a href="{{ route('atasan-langsung.leave-history.index') }}" class="text-sm text-violet-500 hover:text-violet-600 font-medium">Lihat semua →</a>
        </header>
        <div class="p-4">
