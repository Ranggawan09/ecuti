    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto" x-data="leaveRequestsTable()">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    <button
                        ...
                        <svg class="fill-current shrink-0" width="16" height="16" viewBox="0 0 16 16">
                            <path
                                d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8Zm0 12H4V8h4v4Zm4 0H8V8h4v4Zm0-6H4V4h8v2Z" />
                        </svg>
                        <span class="ml-2">Export</span>
                    </button>
                    <div class="origin-top-right z-10 absolute top-full left-0 right-auto min-w-[200px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
                        ...
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex items-center py-1 px-3"
                                    href="{{ route('kepegawaian.leave-requests.export', ['format' => 'excel', 'type' => 'history']) }}"
                                    @click="open = false">
                                    <svg class="w-4 h-4 fill-current text-green-500 shrink-0 mr-2" viewBox="0 0 16 16">
                                        <path
                                            d="M9 7h6v2H9V7Zm0 4h6v2H9v-2Zm-9 0h6v2H0v-2Zm0-4h6v2H0V7Zm0-4h6v2H0V3Zm9 0h6v2H9V3Z" />
                                    </svg>
                            ...
                            <li>
                                <a class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 flex items-center py-1 px-3"
                                    href="{{ route('kepegawaian.leave-requests.export', ['format' => 'pdf', 'type' => 'history']) }}"
                                    @click="open = false">
                    ...
                    <div class="origin-top-right z-10 absolute top-full left-0 right-auto min-w-[200px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
                        ...
                        <div class="px-3 py-2">
                            <label class="flex items-center py-1">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Nama
                                    Pegawai</span>
                            </label>
                            <label class="flex items-center py-1">
                            ...
                            <label class="flex items-center py-1">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Jenis
                                    Cuti</span>
                            </label>
                            <label class="flex items-center py-1">
                            ...
                            <label class="flex items-center py-1">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-300 font-medium ml-2">Total
                                    Hari</span>
                            </label>
                            <label class="flex items-center py-1">
        ...
        <div class="mb-5">
            <div class="relative">
                ...
                <input id="leave-search"
                    ...
                    type="search" placeholder="Cari berdasarkan nama pegawai, NIP, jenis cuti, atau status..."
                    x-model="searchQuery" @input.debounce.300ms="filterLeaveRequests()">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl relative">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">Riwayat Cuti yang Telah Dicetak <span
                        class="text-gray-400 dark:text-gray-500 font-medium"
                        x-text="'(' + filteredLeaveRequests.length + ')'"></span></h2>
            </header>
            <div>
                                ...
                                <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center">
                                        <label class="inline-flex">
                                            ...
                                            <input class="form-checkbox" type="checkbox" x-model="selectAll"
                            ...
                            <template x-for="leave in filteredLeaveRequests" :key="leave.id">
                                <tr class="border-b border-gray-100 dark:border-gray-700/60">
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                        <div class="flex items-center">
                                            <label class="inline-flex">
                                                ...
                                                <input class="form-checkbox" type="checkbox" :value="leave.id"
                                                    x-model="selected">
                                            </label>
                                        </div>
                                    </td>
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap" x-show="columns.nama">
                                        <div class="flex items-center">
                                            <div
                                                class="w-10 h-10 shrink-0 flex items-center justify-center bg-violet-100 dark:bg-violet-500/30 rounded-full mr-2">
                                                <span class="text-sm font-medium text-violet-600 dark:text-violet-400"
                                                    x-text="leave.employee_name.charAt(0).toUpperCase()"></span>
                                            </div>
                                            <div class="font-medium text-gray-800 dark:text-gray-100"
                                                x-text="leave.employee_name"></div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"
                                        ...
                                        <div class="text-center">
                                            <span
                                                class="inline-flex font-medium rounded-full text-center px-2.5 py-0.5 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300"
                                                x-text="leave.total_days + ' hari'"></span>
                                        </div>
                                    </td>
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap"
                                        x-show="columns.status">
                                    ...
                                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                        <div class="flex items-center gap-2">
                                            <a :href="'/kepegawaian/leave-requests/' + leave.id"
                                                class="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-blue-500"
                                                title="View">
                                                <svg class="fill-current shrink-0" width="16" height="16"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M8 2c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6Zm0-2C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8Z" />
                                                    <circle cx="8" cy="8" r="3" />
                                                </svg>
                                            </a>
                                            <!-- Print button for approved requests -->
                                            <a x-show="leave.status === 'disetujui' || leave.status === 'ditangguhkan'"
                                                :href="'/kepegawaian/leave-requests/' + leave.id + '/print'"
                                                target="_blank"
                                                class="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-emerald-500"
                                                title="Cetak">
                                                <svg class="fill-current shrink-0" width="16" height="16"
                                                    viewBox="0 0 16 16">
                                                    <path
                                                        d="M14 0H2c-.6 0-1 .4-1 1v3c0 .6.4 1 1 1h1v2H2c-1.1 0-2 .9-2 2v4c0 1.1.9 2 2 2h1v1c0 .6.4 1 1 1h8c.6 0 1-.4 1-1v-1h1c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2h-1V5h1c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1ZM4 14V9h8v5H4Zm8-9H4V2h8v3Z" />
                                                </svg>
                                            </a>
                            ...
                            <tr x-show="filteredLeaveRequests.length === 0">
                                <td colspan="8" class="px-2 first:pl-5 last:pr-5 py-8">
                                    <div class="text-center text-gray-500 dark:text-gray-400">
                                        <svg class="inline-block w-16 h-16 mb-4 fill-current opacity-20"
                                            viewBox="0 0 64 64">
                                            <circle cx="32" cy="32" r="32" />
                                            <path
                                                d="M32 48c8.8 0 16-7.2 16-16S40.8 16 32 16s-16 7.2-16 16 7.2 16 16 16zm0-28c6.6 0 12 5.4 12 12s-5.4 12-12 12-12-5.4-12-12 5.4-12 12-12z" />
                                            <path
                                                d="M32 40c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm0-12c-2.2 0-4 1.8-4 4s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4z" />
                                        </svg>
                                        <p class="font-medium text-lg mb-1">Tidak ada data</p>
                                        <p class="text-sm">Tidak ditemukan data cuti yang sesuai dengan pencarian Anda.
                                        </p>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <nav class="mb-4 sm:mb-0 sm:order-1" role="navigation" aria-label="Navigation">
                    <ul class="flex justify-center">
                        <li class="ml-3 first:ml-0">
                            <a class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 text-gray-300 dark:text-gray-600"
                                href="#" disabled>&lt;- Previous</a>
                        </li>
                        <li class="ml-3 first:ml-0">
                            <a class="btn bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-violet-500"
                                href="#">Next -&gt;</a>
                        </li>
                    </ul>
                </nav>
                <div class="text-sm text-gray-500 dark:text-gray-400 text-center sm:text-left">
                    Showing <span class="font-medium text-gray-600 dark:text-gray-300"
                        x-text="filteredLeaveRequests.length"></span> of <span
                        class="font-medium text-gray-600 dark:text-gray-300" x-text="allLeaveRequests.length"></span>
                    results
                </div>
            </div>
        </div>
