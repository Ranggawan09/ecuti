                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700/60">
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button @click="(user.has_active_leave || user.has_pending_approvals) ? alert('User tidak dapat dihapus karena masih memiliki proses cuti berjalan atau tanggung jawab persetujuan.') : deleteUser(user.id)" 
                                                class="btn-sm bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-red-500" 
                                                :class="(user.has_active_leave || user.has_pending_approvals) ? 'opacity-50 cursor-not-allowed' : ''"
                                                :title="(user.has_active_leave || user.has_pending_approvals) ? 'Tidak dapat dihapus (Ada proses cuti/persetujuan)' : 'Delete'">
                                             <svg class="fill-current shrink-0" width="16" height="16" viewBox="0 0 16 16">
